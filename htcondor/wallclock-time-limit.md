...
The HTCondor config file is templated from [condor_config.local.j2](https://gitub.com/usegalaxy-eu/infrastructure-playbook/blob/master/templates/htcondor/condor-config.local)
...
they are defined in [group_vars/htcondor/vars.yml](https://gitub.com/usegalaxy-eu/infrastructure-playbook/blob/mast
